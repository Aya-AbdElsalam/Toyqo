...
document.querySelector(".best_seller .slider .slide1").innerHTML = bestProduct
  .map((e) => {
    return `
  <div class="item">
            <div class="img">
...
document.querySelector(".best_seller .slider .slide2").innerHTML = bestProduct2
  .map((e) => {
    return `
  <div class="item">
            <div class="img">
...
document.querySelector(".on_sale .slider .slide1").innerHTML = onSaleProduct
  .map((e) => {
    return `
  <div class="item">
            <div class="img">
...
document.querySelector(".on_sale .slider .slide2").innerHTML = onSaleProduct2
  .map((e) => {
    return `
  <div class="item">
            <div class="img">
